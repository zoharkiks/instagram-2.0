...
const Navbar = () => {
  return (
    <div className=" flex max-w-6xl items-center justify-between rounded-b-2xl py-4 px-2 font-gilSemi shadow-xl md:px-6 xl:mx-auto sticky top-0 z-50 bg-white   ">
