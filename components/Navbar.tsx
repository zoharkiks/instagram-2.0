...
const Navbar = () => {
  return (
    <div className=" flex max-w-6xl items-center justify-between rounded-b-2xl py-4 px-2 md:py-2 font-gilSemi shadow-xl md:px-6 xl:mx-auto sticky top-0 z-50 bg-white   ">
...
<div className="absolute flex -top-2 -right-3 items-center justify-center gradient w-5 h-5 rounded-full animate-pulse text-white text-xs">
  3
</div>
        </div>
